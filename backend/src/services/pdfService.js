  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const policies = [
        ...
        { number: '3.', text: '⁠SE DEBERÁ CUBRIR EL RESTANTE DEL TOTAL DE LA RESERVACIÓN AL MOMENTO DE REALIZAR CHECK IN; PARA EVENTOS PRIVADOS, CON TARIFA ESPECIAL, EL RESTANTE DEBERÁ QUEDAR CUBIERTO 1 MES ANTES DE LA FECHA DE LLEGADA A LA CAPILLA HOTEL.' },
